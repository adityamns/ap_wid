<?php 
	...
	//Row Fields
	$field = new PivotField("prodi_id");
	$field->Text = "Program Studi";
	$pivot->AddRowField($field);

	
	$field = new PivotField("matkul_id");
