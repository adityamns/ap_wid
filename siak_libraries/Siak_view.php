...
class Siak_view{
	...
	function __construct(){
		...
		$this->random = new Siak_Encode(); //base64 encode/decode
		$this->encrypt = new Encryption(); //Encrypt data
	}
	...
	//Menambahkan kondisi status pada query, menu yang tampil adalah status == true
	//Apabila ingin menambahkan menu untuk hak akses namun tidak ingin menampilkannya cukup set status == false
