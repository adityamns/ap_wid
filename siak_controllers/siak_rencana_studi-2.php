...
// 		$this->siak_model->siak_query("update", "UPDATE mahasiswa set edit_id='1', semester = '".$_POST['semester']."', tahun_akademik  = '".$_POST['thn']."', status = '1' WHERE nim = '".$_POST['nim']."'; ");
		...
		if($smstr == "perp1" || $smstr == "perp1"){
			$this->siak_model->siak_query("update", "UPDATE mahasiswa set edit_id='1', perpanjangan = perpanjangan + 1, tahun_akademik  = '".$_POST['thn']."', status = '1' WHERE nim = '".$_POST['nim']."'; ");
		}else{
			$this->siak_model->siak_query("update", "UPDATE mahasiswa set edit_id='1', semester = '".$_POST['semester']."', tahun_akademik  = '".$_POST['thn']."', status = '1' WHERE nim = '".$_POST['nim']."'; ");
		}
