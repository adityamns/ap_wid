...
// 				$status_perbaikan = 2;
			...
			if($status_perbaikan <= 2){
				$updateNilai = "update nilai_mahasiswa set status_perbaikan=$status_perbaikan, nilai_total = '".$_POST['perb'][$key]."' where nim='".$_POST['nim'][$key]."' and matkul_id='".$_POST['matkul']."' and semester = '".$_POST['semester']."'";
				echo $updateNilai."<br>"; //Update Nilai Perbaikan Mahasiswa
// 				$this->siak_model->siak_query("update", $updateNilai);
				
				$insert_per = "insert into perbaikan_nilai(id_nilai_mahasiswa, nilai_total, grade, nim) values('".$_POST['idNilaiOld'][$key]."', '".$_POST['old'][$key]."', '".$_POST['gradeOld'][$key]."', '".$_POST['nim'][$key]."')";
