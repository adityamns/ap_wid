...
class Siak_matakuliah_pil extends Siak_controller{
	...
	function index(){
		...
		$this->siak_view->config = "Siak Widyatama - Mata Kuliah Pilihan";
		
		$this->siak_view->judul = "Mata Kuliah Pilihan";
		
		$this->siak_breadcrumbs->add(array('title'=>'Data Master','href'=>'#'));
		$this->siak_breadcrumbs->add(array('title'=>'Data Matakuliah','href'=>'#'));
		$this->siak_breadcrumbs->add(array('title'=>'Mata Kuliah Pilihan','href'=>'' .URL. 'siak_matakuliah_pil'));
		$this->siak_view->set_breadcrumbs($this->siak_breadcrumbs->output());
		
		//Hak Akses
		$method_or_uri = 'siak_matakuliah_pil';
...
// 		die();
	...
	public function siak_edit_save($matkul_id){
		...
		$tahun=$_POST['tahun_id'];
// 		echo "update matakuliah set jenismatkul_id='$jenismatkul', kode_matkul='$kode', nama_matkul='$nama',en_matkul='$en',singkatan='$sing',sks='$skss',semester='$semes',pertemuan='$temu',penanggungjawab='$jawab',keterangan='$ket' where matkul_id = '$matkul_id';";
// 		die();
		$this->siak_model->siak_query("update", "update matakuliah set prodi_id = '$prodi', jenismatkul_id='$jenismatkul', kode_matkul='$kode', nama_matkul='$nama',en_matkul='$en',singkatan='$sing',sks='$skss',semester='$semes',pertemuan='$temu',penanggungjawab='$jawab',keterangan='$ket' where matkul_id = '$matkul_id';"); 
		
		/*
		///////////////////////////////////////////////////////////////////////////////////////
		//UPLOAD FILE GAJADI DIPAKE
		///////////////////////////////////
		$fileTypes= array('doc','docx','pdf');
		$fileParts = $_FILES['uploaded_file']['name'];
