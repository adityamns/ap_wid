...
class Siak_mahasiswa extends Siak_controller{
	...
	$sql_mhs = "select * from mahasiswa where nim = '$nim' AND prodi_id = '$prodi_id'";
	$mhs = $this->siak_model->siak_query("select",$sql_mhs);
// 	echo $sql_mhs."<br>";
// 	echo "<pre>";
// 	var_dump($mhs);
// 	echo "</pre>";
...
// // 			echo $kondisi;die();
// 
			$kondisi = "AND a.prodi_id = '$prodi_new'";
		}
		else if($this->prodi_id != NULL && $ada == "ada"){
...
// 		var_dump($this->siak_view->siak_data_list);die();
...
// 		header('location: ' . URL . 'siak_master/siak_mahasiswa/'.$nim.'/'.$jenis);
	...
	function cek_kursus( $nim, $jenis, $id, $bahasa, $edit_idx){
		if($edit_idx == NULL){
			$edit_id = '0';
		}else{
			$edit_id = $edit_idx;
...
// 		var_dump($result);die();
		...
		if($result == NULL && $edit_id == '0'){
		    ...
		    <a class="btn red mini" data-toggle="modal" data-target="#hapusMKL" onclick="kirim_id(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-trash"></i> Delete</a>
		    ';
		}
		else if($this->level != '16'){
		    echo '
		    <a class="btn green mini" data-toggle="modal" data-target="#approveMKL" onclick="kirim_id2(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-ok"></i> Approve</a>
		    <a class="btn red mini" data-toggle="modal" data-target="#hapusMKL" onclick="kirim_id(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-trash"></i> Disagree</a>
		    ';
		}
...
// 		var_dump($sql);die();
		...
		if($result == NULL && $edit_id == '0'){
		    ...
		    <a class="btn red mini" data-toggle="modal" data-target="#hapusMKI" onclick="kirim_id(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-trash"></i> Delete</a>
		    ';
		}
		else if($this->level != '16'){
		    echo '
		    <a class="btn green mini" data-toggle="modal" data-target="#approveMKI" onclick="kirim_id2(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-ok"></i> Approve</a>
		    <a class="btn red mini" data-toggle="modal" data-target="#hapusMKI" onclick="kirim_id(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-trash"></i> Disagree</a>
		    ';
		}
...
// 		var_dump($edit_id);die();
		...
		if($result == NULL && $edit_id == '0' || $edit_id == NULL){
		    ...
		    <a class="btn red mini" data-toggle="modal" data-target="#hapusMSI" onclick="kirim_id(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-trash"></i> Delete</a>
		    ';
		}
		else if($this->level != '16'){
		    echo '
		    <a class="btn green mini" data-toggle="modal" data-target="#approveMSI" onclick="kirim_id2(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-ok"></i> Approve</a>
		    <a class="btn red mini" data-toggle="modal" data-target="#hapusMSI" onclick="kirim_id(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-trash"></i> Disagree</a>
		    ';
		}
...
// 		var_dump($sql);die();
		...
		if($result == NULL && $edit_id == '0'){
		    ...
		    <a class="btn red mini" data-toggle="modal" data-target="#hapusMP" onclick="kirim_id(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-trash"></i> Delete</a>
		    ';
		}
		else if($this->level != '16'){
		    echo '
		    <a class="btn green mini" data-toggle="modal" data-target="#approveMP" onclick="kirim_id2(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-ok"></i> Approve</a>
		    <a class="btn red mini" data-toggle="modal" data-target="#hapusMP" onclick="kirim_id(\''.$id.'\',\''.$nim.'\',\''.$bahasa.'\')"><i class="icon-trash"></i> Disagree</a>
		    ';
		}
