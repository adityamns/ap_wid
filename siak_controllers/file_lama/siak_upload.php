...
class Siak_upload extends Siak_controller{
	...
	public function siak_datalist(){
		...
		$this->siak_view->data_silabus = $this->siak_model->siak_query("select", "select * from upload where author = '$user_dir'");
	...
	public function silabus(){
		...
		$this->siak_datalist();
		$this->siak_view->siak_render('siak_upload/silabus', true);
	}
	public function add_silabus(){
		$this->siak_datalist();
...
// 				$file_type=$_FILES['uploaded_file']['type'][$key];
				...
				$query="INSERT INTO upload(matkul_id, nama_file, tahun_id, kode_matkul, location, author, publish) VALUES('$matkul_id','$file_name','$tahun_id[$key]','$kode_matkul', '$desired_dir', '$user_dir', '$publish[$key]'); ";
...
// 				echo "<br> Siap pindah dir baru.<br>";
				$sql_up = "update upload set matkul_id = '$matkul_id', nama_file = '$old_file', kode_matkul = '$kode_matkul', location = '$dir', author = '$user_dir' where upload_id = '$upload_id'";
// 				echo $sql_up;
												
			}else{ // Kalo TIDAK ganti Direktori
			
				$sql_up = "update upload set matkul_id = '$matkul_id', nama_file = '$old_file', kode_matkul = '$kode_matkul', location = '$old_dir', author = '$user_dir' where upload_id = '$upload_id'";
// 				echo $sql_up;
	...
	function create_dir($user_dir){
		$dir = $_POST['new_dir'];
		$location = "siak_public/siak_upload/".$user_dir;
	...
	function cekDir(){ // for xml request
