...
<table style="text-align: left; width: 100%;" border="0" cellpadding="0" cellspacing="0" >
  <thead>
     ...
     <tr align="center">
         <td style="vertical-align: top; text-align: center;"> <br><strong>REKAP DATA ALUMNI</strong></td>
     </tr>
  </thead>
</table>
</htmlpageheader>
...
<table border="1" cellspacing="0" cellpadding="0" width="100%" id="tab1" repeat_header="1">
	<thead>
		<tr>
			...
			<td align = "center" width="5%"><strong>IPK</strong></td>
			<td align = "center" width="20%"><strong>TAHUN MASUK</strong></td>
			<td align = "center" width="20%"><strong>TAHUN LULUS</strong></td>
		</tr>
	</thead>';
...
$html .= '
	<tbody>
		<tr>
			...
			<td align = "center">'.$value['ipk'].'</td>;
			<td align = "center">'.$value['tahun_masuk'].'</td>;
			<td align = "center">'.$value['tahun_lulus'].'</td>';
	$i++;
	}
