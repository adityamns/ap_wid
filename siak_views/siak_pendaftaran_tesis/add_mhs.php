<?php if($this->ada == 0){ ?>
<div class="alert alert-danger">Anda Tidak Lulus Sidang Proposal</div>
<?php }else if($this->afg == "ada"){ ?>
<div class="alert alert-danger">Anda Sudah Mengajukan Judul Tesis</div>
<?php }else if($this->lulus_tesis == "lulus"){ ?>
<div class="alert alert-danger">Anda Sudah Lulus Tesis</div>
<?php // }else if($this->d != 'ada' and $this->cek != NULL){ ?>
<?php }else{ ?>
<div class="row-fluid">
	<div class="span12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption"><i class="icon-globe"></i>Tambah Pendaftaran Judul</div>
			</div>
			<div class="portlet-body">
			
            <?php foreach (Siak_session::siak_get('profil') as $v=>$row){ ?>
			<form id='form' class="horizontal" action = "<?php echo URL;?>siak_pendaftaran_tesis/siak_create/<?php echo $row['nim']; ?>" method = "post">
