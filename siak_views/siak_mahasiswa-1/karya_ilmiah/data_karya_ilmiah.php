...
function kirim_idMKI(id,nim,nama){
	...
	$("#hapus-MKI").attr("href","<?php echo URL; ?>siak_mahasiswa/siak_delete/"+nim+"/kursus_ilmiah/"+id+"/"+"<?php echo $this->jenis?>");
}
...
function kirim_id2MKI(id,nim,nama){
	...
	$("#approve-data-MKi").attr("href","<?php echo URL; ?>siak_mahasiswa/siak_approve/"+nim+"/kursus_ilmiah/"+id+"/"+"<?php echo $this->jenis?>");
}
</script>
...
<div id="approveMKI" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
	...
	<div class="modal-footer">
		<button type="button" data-dismiss="modal" class="btn">Batal</button>
		<a type="button" class="btn green" id="approve-data-MKI" href="#">Approve</a>
	</div>
</div>
