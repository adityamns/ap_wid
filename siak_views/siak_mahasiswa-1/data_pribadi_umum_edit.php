...
<div class="modal-body">
	<div class="portlet-body form">
		<form class="horizontal-form" action = "<?php echo URL;?>siak_mahasiswa/ajaxAplod/umum" method = "post" id="uploadForm" enctype="multipart/form-data">
		<div id="dis_form">
...
<!-- 							<img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" /> -->
							<div id="targetLayer">
									<img src="<?=URL?>siak_public/siak_images/uploads/1201401025.jpg" alt="" />
							</div>
						</div>
