 			...
 			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_lahir_ayah" id="tanggal_lahir_ayah" value="<?php echo $value['tanggal_lahir_ayah']; ?>">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_lahir_ibu" id="tanggal_lahir_ibu" value="<?php echo $value['tanggal_lahir_ibu']; ?>">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
 			...
 			<div class="row-fluid">
				<div class="span12">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_lahir_suamiistri" id="tanggal_lahir_suamiistri" value="<?php echo $value['tanggal_lahir_suamiistri']; ?>">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
