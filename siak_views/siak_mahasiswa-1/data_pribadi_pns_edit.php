...
function loadData(){
    ...
    var strURL = site_url+nim+"/"+jenis+"/"+id+"/"+edit_id;
//     alert(strURL);
	$.ajax({
	    url:strURL,
	    success:function(r){
...
<div class="modal-body">
	<div class="portlet-body form">
		<form class="horizontal-form" action = "<?php echo URL;?>siak_mahasiswa/ajaxAplod/pns" method = "post" id="uploadForm" enctype="multipart/form-data">
		<div id="dis_form">
...
<!-- 							<img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" /> -->
							<img src="<?=URL?>siak_public/siak_upload/Mahasiswa/<?php echo $value['foto'] ;?>" alt="" />
						</div>
						</div>
