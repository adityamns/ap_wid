    ...
    <?php if($this->prodi_users != "ada"){ ?>
				<div class="row-fluid">
                    ...
                    <label class="control-label">PRODI</label>
						<select id="prodi_id" name="prodi_id" class="m-wrap span12" link="<?php echo URL;?>siak_ba_tesis/getbobot" onchange="getBobot(this)">
      ...
      <div class="row-fluid">
                	<div class='span4'>
                    <label class="control-label">TAHUN ANGKATAN</label>
                    	<select id="tahun" name="tahun" class="m-wrap span12" link="<?php echo URL;?>siak_ba_tesis/getbobot" onchange="getBobot(this)">
							<option value="">-- TAHUN ANGKATAN --</option>
							<?php for ($i=2009; $i <= date('Y'); $i++) { ?>
							<option value="<?php echo $i; ?>" ><?php echo $i; ?></option>
							<?php } ?>
