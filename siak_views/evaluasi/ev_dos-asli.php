		  ...
		  <div class="portlet-body">
			  <div class="tabbable tabbable-custom tabs-left">
				  ...
				  <?php
				      ...
				      $kon = "matkul_id = '".$x['matkul_id']."'; ";
				      $datad = $this->db->siak_getfield('matkul_id', 'matakuliah', $kon);
				      $xf = $this->db->fieldNew("select nama_matakuliah from matakuliah where matkul_id = '".$x['matkul_id']."'");
				  ...
				  <?php } else { //echo $this->smstr_mhs;?>
					  ...
					  <li><?php //var_dump($datad);?> - <a href="<?php echo URL.'siak_kartu_hasil_studi/isi_evaluasi/'.$this->nim_mhs.'/'.$x['matkul_id'].'/'.$this->smstr_mhs.'/'.$char[$i]; ?>" data-target="#tabs<?php echo $i.$char[$i]?>" data-toggle="tab"><?=$x['matkul_id']?></a></li>
				  <?php
				  }
				  $i++; }
				  ?>
