...
$(document).ready(function(){ 
	$('#tanggal_lulus').datepicker({
		...
		onSelect: function(dateText, inst) { 
		      ...
		      $('#tanggal_lulus_send').val(year+"-"+(month+1)+"-"+day);
		}
	});
});
</script>
      ...
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
				...
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" id="tanggal_lulus" value="<?php echo date("d-m-Y", strtotime($value['tanggal_lulus'])); ?>">
							<input type="hidden" name="tanggal_lulus" id="tanggal_lulus_send">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
...
<div class="modal-footer">
	...
	<button type="submit" data-dismiss="modal" class="btn green" onclick="EdDP()">Save changes</button>
</div>
<?php } ?>