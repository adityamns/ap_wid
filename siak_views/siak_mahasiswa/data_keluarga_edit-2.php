 			...
 			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_lahir_ayah" id="tgl_lahir_ayah" value="<?php echo date("d-m-Y", strtotime($value['tanggal_lahir_ayah'])); ?>">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_lahir_ibu" id="tgl_lahir_ibu" value="<?php echo date("d-m-Y", strtotime($value['tanggal_lahir_ibu'])); ?>">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
 			...
 			<div class="row-fluid">
				<div class="span12">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tempat_lahir_suamiistri" id="tempat_lahir_suamiistri" value="<?php echo date("d-m-Y", strtotime($value['tempat_lahir_suamiistri'])); ?>">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
 			...
 			<div class="row-fluid">
				<div class="span12">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tgl_lahir_suamiistri" id="tanggal_lahir_suamiistri" value="<?php echo date("d-m-Y", strtotime($value['tanggal_lahir_suamiistri'])); ?>">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
...
$('#tgl_lahir_suamiistri').datepicker({
    dateFormat: 'dd-mm-yy',
    changeMonth: true,
    changeYear: true,
    yearRange: "-100:+0"
 			...
 			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						<label class="control-label" for="tanggal_lahir_ayah">TGL LAHIR AYAH</label>
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_lahir_ayah" id="tgl_lahir_ayah" value="<?php echo $value['tanggal_lahir_ayah']; ?>">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
				<div class="span6">
					<div class="control-group">
						<label class="control-label" for="tanggal_lahir_ibu">TGL LAHIR IBU</label>
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_lahir_ibu" id="tgl_lahir_ibu" value="<?php echo $value['tanggal_lahir_ibu']; ?>">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
 			...
 			<div class="row-fluid">
				<div class="span12">
					<div class="control-group">
						<label class="control-label" for="tanggal_lahir_suamiistri">TGL LAHIR SUAMI/ISTRI</label>
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_lahir_suamiistri" id="tgl_lahir_suamiistri" value="<?php echo $value['tanggal_lahir_suamiistri']; ?>">
      <!-- 						  <span class="help-block">Klik Tombol LIHAT untuk melihat Kode yang tersedia</span> -->
						</div>
					</div>
				</div>
