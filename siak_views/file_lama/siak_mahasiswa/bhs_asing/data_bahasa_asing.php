...
function kirim_id(id,nim,nama){
	...
	$("#hapus").attr("href","<?php echo URL; ?>siak_mahasiswa/siak_delete/"+nim+"/bahasa_asing/"+id+"/"+"<?php echo $this->jenis?>");
}
...
function kirim_id2(id,nim,nama){
	...
	$("#approve-data").attr("href","<?php echo URL; ?>siak_mahasiswa/siak_delete/"+nim+"/bahasa_asing/"+id+"/"+"<?php echo $this->jenis?>");
}
...
function loadPage(){
    $.ajax({
	url:$('#tab-bahasa-asing').attr('href'),
	success: function(r){
	    $('#tab4').html(r);
	},
