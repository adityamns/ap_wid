...
<div class="modal-footer">
	...
	<button type="submit" class="btn green" onclick="document.getElementById('formEditSil').submit();">Save changes</button>
</div>
...
<div id="addDir" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
	...
	<div class="modal-footer">
		...
		<a type="button" class="btn green" data-dismiss="modal" id="updateDir">Save Changes</a>
	</div>
</div>
<script>
