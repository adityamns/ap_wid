...
<div class="modal-body">
				...
				<div class="row-fluid">
					<div class="span6 ">
						<div class="control-group">
							...
							<div class="controls">
									<input type="text" class="m-wrap span12" placeholder="Judul Pelatihan" name="tahun_pelatihan" id="tahun_pelatihan" value="<?php echo $value['tahun_pelatihan']; ?>">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal-footer">
		...
		<button type="submit" class="btn green" onclick="document.getElementById('formPelatihanEdit').submit();">Save changes</button>
	</div>
 	<?php } ?>
