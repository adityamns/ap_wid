...
<div class="panel panel-primary">
	<div class="panel-body" >
		...
		<div class="input-group">
			...
			<a class="btn purple btn-large" href="#addSeminar" data-toggle="modal" link="<?php echo URL; ?>siak_dosen/data_seminar/<?php echo $this->nip?>/add" onclick="addModul(this)">Tambah</a>
		</div>
		<hr>
		<?php } ?>
		...
		<table id="Seminar" class="table table-striped table-bordered table-hover table-full-width">
			...
			foreach ($this->siak_data as $key => $value) {
				...
				echo '
				      <a class="btn blue mini" data-toggle="modal" data-target="#editM" onclick="editModul(this)" link="'.URL.'siak_dosen/data_seminar/'.$this->nip.'/edit/'.$value['id'].'"><i class="icon-edit"></i> Edit</a>
				      <a class="btn red mini" data-toggle="modal" data-target="#static" onclick="kirim_id(\''.$value['nip'].'\',\''.$value['id'].'\',\''.$value['judul_seminar'].'\')"><i class="icon-trash"></i> Delete</a>
				      ';
...
// 				echo $this->deletes=="t"?"&nbsp <a href = '".URL."siak_dosen/siak_delete/".$value['nip']."/seminar_dosen/".$value['id']."' class='ask'> <span class='glyphicon glyphicon-trash'></span> </a>":"";
		...
		<div id="addSeminar" class="modal hide fade" data-width="760">
