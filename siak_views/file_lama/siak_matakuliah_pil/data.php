...
// 				echo $this->deletes=="t"?"&nbsp <a href = '".URL."siak_matakuliah/siak_delete/".$value['matkul_id']."' class='ask'> <span class='glyphicon glyphicon-trash'></span> </a>":"";
				...
				echo '
				      <a class="btn blue mini" data-toggle="modal" data-target="#editMPaket" onclick="editMPaket(this)" link="'.URL.'siak_matakuliah_pil/siak_edit/'.$value['matkul_id'].'"><i class="icon-edit"></i> Edit</a>
