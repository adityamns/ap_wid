	...
	<div class="span12">
		...
		<div class="portlet-body">
        	<div class="input-group">
				<a class=" btn purple btn-large" href="#addDos" data-toggle="modal" link="<?php echo URL; ?>siak_pendaftaran_judul/siak_add/" onclick="add(this)">Tambah</a>
			</div>
			<hr>
...
// 					
					echo '
					      <a class="btn blue mini" data-toggle="modal" data-target="#editM" onclick="edit(this)" link="'.URL.'siak_pendaftaran_judul/siak_edit/'.$value['judultesis_id'].'"><i class="icon-edit"></i>Ubah</a>
					      <a class="btn red mini" data-toggle="modal" data-target="#static" onclick="kirim_id(\''.$value['judultesis_id'].'\',\''.$value['nim'].'\')"><i class="icon-trash"></i>Hapus</a>
					';
...
function ubahSem(value){
	var strURL = "<?php echo URL;?>siak_pendaftaran_judul/coba";
...
function kirim_id(id,nama){
	...
	$("#hapus").attr("href","<?php echo URL; ?>siak_pendaftaran_judul/siak_delete/"+id);
}
</script>
<?php //}else{ ?>
