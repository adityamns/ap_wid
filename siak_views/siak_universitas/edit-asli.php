...
dateFormat: 'dd-mm-yy',
onClose: function() {
    var date = new Date($("#tanggal_mulai_edit").val());
    if (date) {
        var formattedDate = date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate();
        $('#tanggal_mulai_edit_send').val(formattedDate);
    }
},
changeMonth: true,
changeYear: true,
...
dateFormat: 'dd-mm-yy',
onClose: function() {
    var date = new Date($("#tanggal_akta_edit").val());
    if (date) {
        var formattedDate = date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate();
        $('#tanggal_akta_edit_send').val(formattedDate);
    }
},
changeMonth: true,
changeYear: true,
...
dateFormat: 'dd-mm-yy',
onClose: function() {
    var date = new Date($("#tanggal_pengesahan_edit").val());
    if (date) {
        var formattedDate = date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate();
        $('#tanggal_pengesahan_edit_send').val(formattedDate);
    }
},
changeMonth: true,
changeYear: true,
