...
<select id="status" name="status" class="form-control" link="<?php echo URL;?>siak_mahasiswa_lap/getbobot"
...
<div class="control-group">
	...
	<div class="controls">
    <form action="<?=URL?>siak_mahasiswa_lap/pdf" method="post">
		<input type="hidden" name="status" value="<?=$ail['status']?>">
