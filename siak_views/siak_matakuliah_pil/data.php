...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="icon-reorder"></i>Data MataKuliah Pilihan</div>
	</div>
	<div class="portlet-body">
	<?php if ($this->rolePage['creates'] == "t") { ?>
		<div class="input-group">
			<a class=" btn purple btn-large" href="#addMPaket" data-toggle="modal" link="<?php echo URL; ?>siak_matakuliah_pil/siak_add/" onclick="addMPaket(this)">Tambah</a>
		</div>
		<hr>
	<?php } ?>
...
// 	}
	...
	?>
		...
		<table id = "matakuliah_pil" class="table table-striped table-bordered table-hover table-full-width">
		<thead>
			<tr align = "center">
				<td>NO</td>
...
// 				echo $this->deletes=="t"?"&nbsp <a href = '".URL."siak_matakuliah/siak_delete/".$value['matkul_id']."' class='ask'> <span class='glyphicon glyphicon-trash'></span> </a>":"";
				...
				echo '
				      <a class="btn blue mini" data-toggle="modal" data-target="#editMPaket" onclick="editMPaket(this)" link="'.URL.'siak_matakuliah_pil/siak_edit/'.$value['matkul_id'].'"><i class="icon-edit"></i> Ubah</a>';
				}
...
function kirim_id(id,nama){
	...
	$("#hapus").attr("href","<?php echo URL; ?>siak_matakuliah_pil/siak_delete/"+id);
}
</script>
<?php }else{ ?>
