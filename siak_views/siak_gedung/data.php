...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="icon-home"></i>Data Gedung</div>
	</div>
	<div class="portlet-body">
	
		<?php if ($this->rolePage['creates'] == "t") { ?>
		<div class="input-group">
			<a class="btn purple btn-large" href="#addGed" data-toggle="modal" link="<?php echo URL; ?>siak_gedung/siak_add/" onclick="addUsers(this)">Tambah</a>
		</div>
		<?php } ?>
		<hr>
...
// 			echo $this->updates=="t"?"<a class='btn blue mini' data-toggle='modal' data-target='#editGed' onclick='editUsers(this)' link = '".URL."siak_gedung/siak_edit/".$value['id']."'> <i class='icon-edit'></i> Ubah</a>":"";
// 			echo $this->deletes=="t"?"<a class='btn red mini' data-toggle='modal' data-target='#hapusGed' onclick=\"kirim_id('".$value['id']."', '".$value['nama']."')\" > <i class='icon-trash'></i> Hapus</a>":"";
			if ($this->rolePage['updates'] == "t") {
			echo "<a class='btn blue mini' data-toggle='modal' data-target='#editGed' onclick='editUsers(this)' link = '".URL."siak_gedung/siak_edit/".$value['id']."'> <i class='icon-edit'></i> Ubah</a>";
			}
			if ($this->rolePage['deletes'] == "t") {
			echo "<a class='btn red mini' data-toggle='modal' data-target='#hapusGed' onclick=\"kirim_id('".$value['id']."', '".$value['nama']."')\" > <i class='icon-trash'></i> Hapus</a>";
			}
			echo "</td>";
			}
			echo "</tr>";
