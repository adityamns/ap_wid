...
<table style="text-align: left; width: 100%;" border="0" cellpadding="0" cellspacing="0" >
  <thead>
     ...
     <tr align="center">
         <td style="vertical-align: top; text-align: center;"> <br><strong>BA SIDANG PROPOSAL TESIS</strong></td>
     </tr>
  </thead>
</table>
</htmlpageheader>
...
<table border="1" cellspacing="0" cellpadding="0" width="100%" id="tab1" repeat_header="1">
	...
	<br>
	Ujian Judul Proposal telah berlangsung dengan tertib dan lancar. Panitia Ujian Judul Proposal menyatakan bahwa mahasiswa :<br>';
	if($this->hasil == 1){
	$html .= '
	<input type="checkbox" checked="checked"> Lulus Ujian Judul Proposal<br>
	<input type="checkbox"> Tidak Lulus Ujian Judul Proposal<p>';
	}else{
	$html .= '
	<input type="checkbox"> Lulus Ujian Judul Proposal<br>
	<input type="checkbox" checked="checked"> Tidak Lulus Ujian Judul Proposal<p>';
	}
	$html .= '
	Dengan Catatan :<br>
