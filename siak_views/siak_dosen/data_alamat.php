				...
				<div class="row-fluid">
					...
					<div class="span6 ">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="m-wrap span12" placeholder="Kode pos" name="kode_pos" id="kode_pos" value="<?php echo $value['kode_pos']; ?>">
	      					</div>
						</div>
					</div>
				</div>
				...
				<div class="row-fluid">
					...
					<div class="span6 ">
						<div class="control-group">
							<label class="control-label" for="firstName">KODE POS</label>
							<div class="controls">
								<input type="text" class="m-wrap span12" placeholder="Kode pos" name="kode_pos" id="kode_pos">
	      					</div>
						</div>
					</div>
				</div>
