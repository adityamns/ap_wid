...
<table id="mahasiswa" class="table table-bordered table-striped table-hover table-contextual table-responsive">
    ...
    TH : TIDAK HADIR
		...
		foreach ($this->data_mahasiswa as $key => $valueasd) {
			...
			echo "<td align='center'>" . strtoupper($valueasd['nama_depan']) . " ".strtoupper($valueasd['nama_belakang'])."<input type='hidden' id='nim' value='" . $valueasd['nim'] . "'></td>";
...
// 				$status= $check_data[1]==1?"H":"TH";
		...
		<tr align = "center">
			<td colspan="2" align="center">PERTEMUAN</td>
		    <td>1</td>
		    <td>2</td>
		    <td>3</td>
		    <td>4</td>
