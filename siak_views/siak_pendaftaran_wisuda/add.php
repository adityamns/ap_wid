...
<div class="modal-body">
	<div class="scroller" data-always-visible="1" data-rail-visible1="1">
		<div class="portlet-body form">
			...
			<form id="formSetting" name="users" class="horizontal-form" method = "post" action = "<?php echo URL;?>siak_pendaftaran_wisuda/siak_create">
				...
				<div class="row-fluid">
					<div class="span6">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="m-wrap span12" id="nim" name="nim" placeholder="NIM...">
							</div>
						</div>
					</div>
					<!--/span-->
				...
				<div class="row-fluid">
					<div class="span6">
						<div class="control-group">
							...
							<div class="controls">
								<select class="m-wrap span12" name="gelombang">
								<option value="0">-- Pilih --</option>
                                <?php foreach($this->gelombang as $keyy => $vall) { ?>
								<option value="<?php echo $vall['kode']; ?>"><?php echo $vall['nama']; ?></option>
								<?php } ?>
								</select>
							</div>
						</div>
				...
				<div class="row-fluid"> -->
					<div class="span6">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="m-wrap span12" id="tanggal_mulai_wisuda">
				...
				<div class="row-fluid">
					<div class="span6">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="m-wrap span12" id="tanggal_selesai_wisuda">
