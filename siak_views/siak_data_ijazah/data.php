	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="input-group">
				<a class=" btn purple btn-large" href="#addDos" data-toggle="modal" link="<?php echo URL; ?>siak_data_ijazah/siak_add/" onclick="add(this)">Tambah</a>
			</div>
			<hr>
...
function ubahSem(value){
	var strURL = "<?php echo URL;?>siak_data_ijazah/mahasiswa";
...
function kirim_id(id,nama){
	...
	$("#hapus").attr("href","<?php echo URL; ?>siak_data_ijazah/siak_delete/"+id);
}
