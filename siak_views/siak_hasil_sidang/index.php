	...
	<div class="portlet-body">
				<div class="row-fluid">
                    ...
                    <label class="control-label">PRODI</label>
						<select id="prodi_id" name="prodi_id" class="m-wrap span12" link="<?php echo URL;?>siak_hasil_sidang/siak_datalist" onchange="getBobot(this)">
...
<div class="portlet box blue">
	...
	<div class="portlet-body">
				<div class="row-fluid">
                	<div class='span4'>
                    <label class="control-label">TAHUN ANGKATAN</label>
                    	<select id="tahun" name="tahun" class="m-wrap span12" link="<?php echo URL;?>siak_hasil_sidang/siak_datalist" onchange="getBobot(this)">
							<option value="">-- TAHUN ANGKATAN --</option>
							<?php for ($i=2009; $i <= date('Y'); $i++) { ?>
							<option value="<?php echo $i; ?>" ><?php echo $i; ?></option>
							<?php } ?>
                    ...
                    <input type="hidden" id="prodi_id" value="<?php echo $di['prodi_id']; ?>">
                    <?php } ?>
                    <label class="control-label">PRODI</label>
						<select name="prodi_id" class="m-wrap span12" disabled>
                        	<?php foreach($this->prodi as $pro => $di){ ?>
							<option><?php echo $di['prodi']; ?></option>
                            <?php } ?>
						</select>
					</div>
				</div>
