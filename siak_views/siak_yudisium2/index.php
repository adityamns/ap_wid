...
<div class="portlet box blue" >
	...
	<div class="portlet-body">
				<div class="row-fluid">
			<form class="form-horizontal" method = "post" action="<?php echo URL;?>siak_yudisium2">
					...
					<div class="span4"><select link="<?php echo URL;?>siak_yudisium2/Data_IPK"  onchange='getBobot(this)' id="prodi" name="prodi" class="m-wrap span12"><option value="">- PRODI -</option></select></div>
