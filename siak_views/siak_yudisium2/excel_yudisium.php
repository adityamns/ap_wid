...
header("Content-Disposition: attachment; filename=Transkrip_Per_Prodi.xls");//ganti nama sesuai keperluan
...
function ngitung($data,$id,$sks){
 ...
 <form action="<?=URL?>siak_yudisium2/excel_yudisium/<?php echo $this->tahun."/".$this->prodi ?>" " method="post">
 <br>
