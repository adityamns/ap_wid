<div class="portlet box blue" >
	<div class="portlet-title">
		<div class="caption"><i class="icon-home"></i>Cetak Ijazah</div>
	</div>
	<div class="portlet-body">
				<div class="row-fluid">
					<!-- <div class="form-group col-md-2"><label for="status" class="control-label">JENIS MATERI</label></div> -->
					<div class="span3" >
		<select id="cohort_id" name="cohort_id" class="m-wrap span12" link="<?php echo URL;?>siak_cetak_ijazah/cohort" class="form-control" onchange="getKurikulum(this)">
    ...
    <div id="statediv">
    <div class="span4" >
		<select id="prodi_id" name="prodi_id" class="m-wrap span12" link="<?php echo URL;?>siak_cetak_ijazah/getbobot" onchange="getBobot(this)">
