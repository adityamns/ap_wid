     ...
     <div class="scroller" style="height:300px" data-always-visible="1" data-rail-visible1="1">
	       ...
	       <form id="formEditTopik" class="horizontal-form" action = "<?php echo URL;?>/siak_topik/siak_edit_save/<?php echo $value['id'];?>" method = "post">
		    <div class="row-fluid">
			 ...
			 <div class="span6 ">
				 <div class="control-group">
					 <label class="control-label" for="kode_topik">Kode TTopik</label>
					 <div class="controls">
...
<div class="modal-footer">
     ...
     <button type="submit" class="btn green" onclick="document.getElementById('formEditTopik').submit();">Simpan</button>
</div>
