<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="icon-globe"></i>Daftar Sidang Tesis</div>
	</div>
				...
				<div class="row-fluid">
					<div class="span6">
						...
						<div class="form-group col-md-3">
								<input type = "button" value = "CEK" link="<?php echo URL;?>siak_pendaftaran_sidang_tesis/siak_cek" onclick="getKurikulum(this)" class = "btn green "/>
