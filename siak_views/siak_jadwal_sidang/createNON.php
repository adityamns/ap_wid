...
<div class="panel panel-default">
	...
	<input type="hidden" id="tahun_id" value='<?php echo $this->tahunid; ?>'>
		...
		<!-- ****************************** -->
		<!-- DIALOG CREATE -->
		<div id="dialog-create" title="Create Kegiatan">
		<form id='form-buat'>
						<input type="hidden" id="id_prodi" value='<?php echo $this->prodi; ?>'>
								<input type="hidden" class="form-control" name="title" id="judul" placeholder="Judul...">
					...
					<div class="row">
						<div class="form-group col-md-4">
							...
							<div class="form-group col-md-8">
								<div id="statediv">
									<select class='form-control' name='ruang' id='matkul'>
										<option value='' selected>-- PILIH --</option>
										</select>
								</div>
							</div>
