		...
		<tbody>
			...
			foreach ($this->siak_data_list as $key => $value) {
				...
				echo "<td align = 'center'> 
				      <a class='btn blue mini' data-toggle='modal' data-target='#editR' onclick='editRole(this)' link= '".URL."gw/gw_edit/".$value['group_id']."'><i class='icon-edit'></i> Ubah</a>";
				echo '<a class="btn red mini" data-toggle="modal" data-target="#hapusMRole" onclick="kirim_id(\''.$value['group_id'].'\',\''.$nama.'\')"><i class="icon-trash"></i> Hapus</a>
				      </td>';
				echo "</tr>";
			}
			?>
