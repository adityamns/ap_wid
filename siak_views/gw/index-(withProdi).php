...
{	
	$('#tabel_modul').append(
		...
		'<td><input type="hidden" name="allow_read_i[]" value="'+obj.read+'"/><input type="checkbox" onclick="click_checkbox(this,3)" '+obj.read_check+'/></td>'+
		'<td><input type="hidden" name="allow_create_i[]" value="'+obj.create+'"/><input type="checkbox" onclick="click_checkbox(this,4)" '+obj.create_check+'/></td>'+
		'<td><input type="hidden" name="allow_update_i[]" value="'+obj.update+'"/><input type="checkbox" onclick="click_checkbox(this,5)" '+obj.update_check+'/></td>'+
		'<td><input type="hidden" name="allow_delete_i[]" value="'+obj.delete+'"/><input type="checkbox" onclick="click_checkbox(this,6)" '+obj.delete_check+'/></td>'+
		'<td><input type="hidden" name="pribadi_i[]" value="'+obj.pribadi+'"/><input type="checkbox" onclick="click_checkbox(this,7)" '+obj.pribadi_check+'/></td>'+
