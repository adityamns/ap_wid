		...
		//FUNCTION UNTUK SET NEXT DAN PREV
			...
			eventClick: function(event) {
				...
				jQuery('#tanggal').datepicker({
						...
						maxDate: new Date(parseInt(<?php echo $this->tahun; ?>)+1, 3, 30),
						...
						<div class="portlet-body light-grey">
							<div class="row-fluid">
								<div class="span3 responsive" data-tablet="span12 fix-margin" data-desktop="span8">
									...
									<form id="users" name="users"  method = "post" action = "<?php echo URL;?>siak_cetak/kalender_akademik3">
										...
										<input type='hidden' name='jenis' value='<?php echo $this->jenis; ?>' id="jenis-2">
											...
											<div><a href="javascript:;" id="event_add" class="btn green">Cetak</a> &nbsp; <a href="javascript:;"  class="btn yellow" onclick='history.go(-1);'>Kembali </a></div>
									</form>
