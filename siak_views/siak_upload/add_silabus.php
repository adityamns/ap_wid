			...
			<div class="row-fluid">
				<div class="span12">
					<div class="control-group">
						...
						<div class="controls">
						<input type="hidden" name="jenis_upload_id" value="<?=$this->id?>"/>
						<?php
...
<div class="modal-footer">
	...
	<button type="submit" class="btn green" onclick="document.getElementById('formAddSil').submit();">Simpan</button>
</div>
...
<div id="addDir" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
	...
	<div class="modal-footer">
		<button type="button" data-dismiss="modal" class="btn">Batal</button>
		<a type="button" class="btn green" data-dismiss="modal" id="simpanDir">Simpan</a>
	</div>
</div>
<script>
