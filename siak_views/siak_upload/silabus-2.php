		...
		<tbody>
			...
			$new_x = implode('-', $x);
				...
				echo '
				      ...
				      <a class="btn red mini" data-toggle="modal" data-target="#hapusSil" onclick="kirim_id(\''.$value['upload_id'].'\',\''.$new_x.'\',\''.$value['nama_file'].'\',\''.$this->id.'\')"><i class="icon-trash"></i> Hapus</a>
				      ';
