					...
					?>
							<tr>
								...
								<td>
									...
									<a href="#perbaikan" data-toggle="modal" onclick='addPer(this);' link='<?php echo URL."siak_penilaian/perbaikan_nilai/".$this->prodi."/".$this->tahun."/".$this->semester."/".$this->matkul."/".$value['id_komponen']."/".$n?>'><i class='icon-check'></i>Perbaikan</a>
									<?php } } ?>
								</td>
								<td>
