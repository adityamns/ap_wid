...
<div class="alert alert-warning">Pengajuan Judul Tesis Sudah Dikonfirmasi, Silahkan klik Daftar untuk Mendaftar Sidang</div>
<!--<div class="panel panel-danger" style="width:650px;">
	...
	<div class="panel-body">
 	<div class="container-fluid">-->
 		<form method = "post" class="form-horizontal" action = "<?php echo URL;?>siak_pendaftaran_sidang/siak_ok/<?php echo $value['judultesis_id'];?>">
            <div class="row-fluid">
				<div class="span6">
...
<?php } }else if($this->over != NULL){ ?>
	...
	<div class="alert alert-danger">Anda Sudah Mendaftar Sidang Proposal</div>
    <?php }else{ ?>
    <div class="alert alert-danger">Mahasiswa ini Sudah Mendaftar Sidang Proposal</div>
    <?php } ?>
	<?php } else { ?>
    <?php if(Siak_session::siak_get('level')==16){ ?>
