		  ...
		  <div class="portlet-body">
			  <div class="tabbable tabbable-custom tabs-left">
				  ...
				  <ul class="nav nav-tabs tabs-left">
					  <li><a href="<?php echo URL; ?>siak_mahasiswa/data_pribadi/<?php echo $this->nim."/".$this->jenis;?>/edit" data-target="#tabs1" data-toggle="tab">PRIBADI</a></li>
					  <li><a href="<?php echo URL; ?>siak_mahasiswa/data_keluarga/<?php echo $this->nim."/".$this->jenis;?>/edit" data-target="#tabs2" data-toggle="tab">KELUARGA</a></li>
					  <li><a href="<?php echo URL; ?>siak_mahasiswa/data_pendidikan/<?php echo $this->nim."/".$this->jenis;?>/data" data-target="#tabs3" data-toggle="tab">PENDIDIKAN</a></li>
					  ...
					  <li><a href="<?php echo URL; ?>siak_mahasiswa/data_pekerjaan/<?php echo $this->nim."/".$this->jenis;?>/data" data-target="#tabs9" data-toggle="tab">PEKERJAAN</a></li>
					  <?php } ?>
					  <?php if ($this->jenis == "pns") { ?>
					  <li><a href="<?php echo URL; ?>siak_mahasiswa/data_riwayat_pendidikan/<?php echo $this->nim."/".$this->jenis;?>/data" data-target="#tabs9" data-toggle="tab">RIWAYAT PENDIDIKAN</a></li>
					  <li><a href="<?php echo URL; ?>siak_mahasiswa/data_riwayat_pangkat/<?php echo $this->nim."/".$this->jenis;?>/data" data-target="#tabs10" data-toggle="tab">RIWAYAT PANGKAT</a></li>
					  <?php } ?>
				  </ul>
