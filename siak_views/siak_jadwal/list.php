<?php 
// echo "<pre>";
// var_dump(Siak_session::siak_get('prodi'));
// echo "</pre>";
			...
			<?php } ?>
				...
				<?php
					...
					foreach ($this->siak_data as $key => $value) {
						...
						"&nbsp <a href = '".URL."siak_jadwal/siak_delete_jadwal_prodi/".$value['tahun_id']."/".$value['prodi_id']."/".$value['cohort']."' class='btn yellow mini'>Hapus</a>"
						:""
						;
					echo "</td></tr>";
				}
