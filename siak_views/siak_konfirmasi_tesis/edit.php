<div class="modal-body">
	<div class="scroller" data-always-visible="1" data-rail-visible1="1">
		...
		<form id="formKonf" method = "post" action = "<?php echo URL;?>siak_konfirmasi_tesis/siak_edit_save/<?php echo $value['id'];?>">
            ...
            <div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" readonly value="<?php
