...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><i class="icon-home"></i>Setting Batas Waktu Absen</div>
	</div>
	<div class="portlet-body">
		<?php if ($this->rolePage['creates'] == "t") { ?>
		<div class="input-group">
			<!--a class="btn purple btn-large" href="#addJGed" data-toggle="modal" link="<?php echo URL; ?>siak_setting_batas_waktu_absen/siak_add/" onclick="addUsers(this)">Tambah</a-->
		</div>
		<hr>
		<?php } ?>
...
// 			echo $this->updates=="t"?"<a class='btn blue mini' data-toggle='modal' data-target='#editJGed' onclick='editUsers(this)' link = '".URL."siak_setting_batas_waktu_absen/siak_edit/".$value['id']."'> <i class='icon-edit'></i> Ubah</a>":"";
// 			echo $this->deletes=="t"?"<a class='btn red mini' data-toggle='modal' data-target='#hapusJGed' onclick=\"kirim_id('".$value['id']."', '".$value['nama']."')\" > <i class='icon-trash'></i> Hapus</a>":"";
			...
			echo "<a class='btn blue mini' data-toggle='modal' data-target='#editJGed' onclick='editUsers(this)' link = '".URL."siak_setting_batas_waktu_absen/siak_edit/".$value['id']."'> <i class='icon-edit'></i> Ubah</a>";
			}
...
function kirim_id(id,nama){
	...
	$("#hapus").attr("href","<?php echo URL; ?>siak_setting_batas_waktu_absen/siak_delete/"+id);
}
</script>
<?php }else{ ?>
