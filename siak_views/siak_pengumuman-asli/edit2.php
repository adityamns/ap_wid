		...
		<?php foreach ($this->siak_data_list as $key => $value) { ?>
 		<form id="formEditKeg" class="horizontal-form" action = "<?php echo URL;?>siak_pengumuman/siak_edit_save/<?=$value['acara_id']?>" method = "post">
			...
			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_mulai" id="awal" readonly value="<?=$value['tanggal_mulai']?>">
						</div>
					</div>
				</div>
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_akhir" id="akhir" readonly value="<?=$value['tanggal_akhir']?>">
						</div>
					</div>
				</div>
			</div>
			<div class="row-fluid">
				<div class="span12">
					<div class="control-group">
						...
						<div class="controls">
							<textarea class="m-wrap span12" name="pengumuman" placeholder="Isi Acara..."><?=$value['isi_acara']?></textarea>
						</div>
					</div>
				</div>
			</div>
			...
			<table id ="berita" class="table table-bordered table-striped table-hover table-contextual table-responsive">
				...
				foreach(explode(',', $value['prodi_id']) as $row => $rec){
				?>
				<tr>
					<th width="10%">
			...
			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						<label class="control-label" for="tanggal_mulai">Tanggal Mulai</label>
						<div class="controls">
							<input type="text" class="m-wrap span12" name="tanggal_mulai" id="awal2" readonly>
						</div>
					</div>
				</div>
				<div class="span6">
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="control-group">
						...
						<div class="controls">
							<textarea class="m-wrap span12" name="pengumuman" ></textarea>
						</div>
					</div>
				</div>
			</div>
